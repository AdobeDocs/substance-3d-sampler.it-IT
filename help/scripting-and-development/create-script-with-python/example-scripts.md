...
Gli script seguenti possono essere utilizzati per illustrare il funzionamento dell’API di Sampler. Sentitevi liberi di utilizzare e aggiungere a questi script in base alle esigenze del vostro flusso di lavoro.

## Esporta tutto

Esporta il materiale con vari predefiniti di esportazione.
...
## Importare i metadati da un file CSV

Questo script importa e crea metadati personalizzati da un file CSV: [material\_physical\_property\_clo.csv](https://helpx.adobe.com/content/dam/help/en/substance-3d/documentation/sadoc/files/234455545/255426646/1/1680276968224/material-physical-property-clo.csv)
...
## Mostra tutti i parametri colore

Questo script espone il parametro colore di ogni livello nel gruppo di livelli.
