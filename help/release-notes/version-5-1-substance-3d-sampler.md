...
Aumentate le prestazioni e riducete il tempo di calcolo con il livello Appiattito trasformando i risultati dei livelli sovrapposti in un unico insieme di mappe all&#39;interno di un livello unificato. Rinominatele e duplicatele per una maggiore efficienza.
...
Con i filtri ottimizzati Equalizza e Timbro clone, oltre a una nuova funzione di rimozione automatica delle pieghe per i tessuti, puoi ottenere scansioni perfette in pochi clic, indipendentemente dalla complessità del materiale.
...
* [Filtri] Nuove funzioni del filtro Timbro clone
...
* [Prestazioni] Miglioramento dell&#39;utilizzo della memoria per la vista 3D
...
* [UI] Avvisa in caso di deprecato authoring luce ambiente
...
* [Vista 3D] Il passaggio al rendering Traccia percorso si arresta in modo anomalo su hardware non supportato
* [Applicazione] L&#39;applicazione si blocca quando si chiude il popup della misura manuale senza impostare una dimensione
* Arresto anomalo di [Application]
* [Applicazione] Blocco in Windows durante la visualizzazione del desktop (tasto Windows + scelta rapida da tastiera D)
* [Applicazione] Possibile arresto anomalo quando si cambia lingua
* [Captis] Arresto anomalo quando i dati di anteprima non sono validi
...
* [Filtri] L’anteprima del pennello quando si utilizza il filtro Timbro clone potrebbe essere errata a seconda delle dimensioni della texture e del pennello
...
* [Livelli] Calcoli non necessari durante l’importazione di immagini nella pila di livelli
...
* [UI] Texture Tilling V Parametro parzialmente nascosto in Impostazioni visualizzatore e Vista 3D
