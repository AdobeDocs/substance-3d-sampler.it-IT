---
helpx_url: "https://helpx.adobe.com/it/substance-3d-sampler/release-notes/old-versions/version-3-1.html"
breadcrumb-title: ''
...
Sampler ora supporta i file SVG. Puoi importarli nelle tue risorse, direttamente nella pila di livelli o in un input di immagine del livello.
...
Sampler ora dispone di un widget Ritaglio adeguato e rinnovato per definire facilmente l’area ritagliata. Non si otterranno risultati allungati nemmeno quando si ritagliano immagini non quadrate in texture quadrate.
...
Tutti i parametri dei materiali delle impostazioni di Shader (scala normale, scala height, livello height,...) verrà esportato nel file SBSAR per essere letto in Substance 3D Stager per una corrispondenza perfetta dei materiali.
...
* [Applicazione] Nella vista 2D, la normale viene visualizzata nel formato normale impostato nelle preferenze
...
* [Export] Aggiungere le impostazioni dello shader alle esportazioni di file SBS e SBSAR
...
* [Esportazione] Arresto anomalo durante l’esportazione con un predefinito personalizzato appena aggiunto
* [Esporta] Dimensioni stimate del pacchetto mancanti nel popup di esportazione
* [Export] Correggere la perdita di memoria durante l’esportazione di file SBS e SBSAR
* [Filtri composti] I filtri composti possono avere ingressi duplicati
* [Filtri composti] Arresto anomalo se un filtro contiene riferimenti non soddisfatti
* [Filtri composti] Arresto anomalo quando si riordina una pila di livelli contenente un filtro composto
...
* [Layers] Arresto anomalo quando si aggiunge un Materiale di base
* [Layers] Arresto anomalo quando si utilizza un’immagine non valida come luce ambiente
...
* [Progetto] Arresto anomalo durante il caricamento di un file di progetto incompleto
* [Progetto] Arresto anomalo all’apertura di un progetto danneggiato
...
* [Realtime Engine 2021] Un calcolo intenso può causare l&#39;arresto anomalo dell&#39;applicazione
* [Realtime Engine 2021] Il motore in tempo reale 2021 si arresterà in modo anomalo su un computer Windows con CPU AMD e GPU Nvidia installate
