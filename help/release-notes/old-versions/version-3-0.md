---
helpx_url: "https://helpx.adobe.com/it/substance-3d-sampler/release-notes/old-versions/version-3-0.html"
breadcrumb-title: ''
description: Consultate le note sulla versione per Substance 3D Sampler versione 3.0 per informazioni sulla rielaborazione dell'interfaccia utente, sulla luce ambientale, sui filtri e sull'integrazione delle Creative Cloud.
...
**Substance 3D Sampler 3.0.0** è il nuovo nome di Substance Alchemist ora che è connesso a Adobe Creative Cloud. Offre una rielaborazione completa dell&#39;interfaccia utente, supporto per la creazione di Luce ambientale, filtri completamente rielaborati e nuovi, funzionalità Invia a e supporto degli shader ASM.
...
### Nuova creazione Luce ambientale

![](../../assets/idl.jpg){width="600px"}

Sampler ora consente di creare più di semplici materiali. Le luci ambientali sono un nuovo tipo di risorsa con il relativo [set di filtri](../../filters/hdri-tools/hdri-tools.md). Inizia da [360 foto tra parentesi](../../filters/hdri-tools/hdr-merge.md), crea una luce ambientale [da zero](../../filters/hdri-tools/shape-light.md) o [modifica un file HDR esistente](../../filters/hdri-tools/nadir-patch.md).
...
* [Altera Trasforma](../../filters/tools/warp-transform.md)
...
* Passare da 2 [motori in tempo reale](https://helpx.adobe.com/it/substance-3d/unlisted/documentation/sadoc/viewer-settings-188973164.html)
...
* Supporto per texture non quadrata
...
* [UI] Nuova barra degli strumenti per accedere a filtri specifici direttamente (Ritaglia, Trasforma, Prospettiva Trasforma, Clona /Clone timbro)
...
* [UI] Scelta rapida da tastiera: utilizzate &quot;2&quot; per attivare/disattivare la visibilità della Vista 2D
* [UI] Scelta rapida da tastiera: utilizzate &quot;3&quot; per attivare/disattivare la visibilità della vista 3D
...
* [Pannello Progetto] Crea una risorsa (materiale o luce ambientale) utilizzando l&#39;icona +
...
* [Luce ambientale] Creare una luce ambientale in Substance 3D Sampler
* [Luce ambientale] Durante la creazione di una luce ambientale, trascinando le immagini viene visualizzata la finestra Modello di creazione Luce ambientale
* [Luce ambientale] Nel Modello di creazione di Luci ambientali, seleziona Importazione ambiente per assegnare l&#39;immagine all&#39;ambiente nella vista 3D
* [Luce ambientale] Nel modello di creazione della Luce ambientale, selezionate Unione HDR per creare una luce ambientale da diverse immagini a 360 gradi con diversa esposizione
* [Luce ambientale] Nel modello di creazione di Luci ambientali, seleziona &quot;Usa come bitmap&quot; per modificare le immagini prima di creare una luce ambientale
* [Luce ambientale] Assegna l’utilizzo dell’ambiente nel livello Importazione immagine per assegnare direttamente l’immagine all’ambiente nella vista 3D
* [Luce ambientale] Nella Vista 2D del canale di ambiente, è disponibile una correzione automatica del colore che consente di visualizzare il rendering come nella vista 3D
* [Luce ambientale] Nuovi contenuti dedicati per la creazione di luce ambientale
...
* [Pannello Livelli] Scelta rapida da tastiera - Maiusc + B aggiunge un materiale di base sopra i livelli
...
* [Esporta] Invia materiali e luce ambientale ad Adobe Substance 3D Painter
* [Esporta] Inviare luci ambientali ad Adobe Substance 3D Stager
...
* [Rendering] Aggiunta del supporto del rivestimento (Colore del rivestimento, Rugosità del rivestimento, Normale dei rivestimenti, Livello speculare dei rivestimenti e rivestimento IOR)
* [Rendering] Aggiunta del supporto Anisotropie (Livello di anisotropia e Angolo di anisotropia)
...
* [Rendering] Il modulo di rendering in tempo reale (2021) supporta le proprietà traslucidità, assorbimento e dispersione del materiale
* [Rendering] Il modulo di rendering in tempo reale (2021) introduce un nuovo modo di calcolare le ombre dalla luce ambientale
* [Rendering] Il modulo di rendering in tempo reale (2021) calcola in tempo reale l’irradianza della luce ambientale
* [Pannello Impostazioni Shader] Nuovo pannello Impostazioni Shader per modificare parametri specifici di shader del materiale
* [Pannello delle impostazioni dello Shader] Nuovi parametri (Scala normale, Scala height, Livello height, Intensità di emissione, IOR, Intensità Normale dei rivestimenti e Coat IOR)
...
* [Pannello Shader impostazioni] I valori delle impostazioni vengono salvati per risorsa.
* [Pannello impostazioni visualizzatore] È stata aggiunta un&#39;anteprima delle luci ambientali predefinite
...
* [Contenuto] Nuove luci ambientali predefinite
...
* [Contenuto] Nuovo filtro Trasforma alterazione
...
* [Content] Affiancamento - opzione per visualizzare le cuciture tagliate
* [Content] Affiancamento - opzione per pittura le cuciture tagliate per un Affiancamento perfetto
...
* [Content] Luce ambiente - Nuovo filtro di unione HDR
...
* [Widget] I widget Trasforma e Posizioni possono scomparire. Nascondi e Mostra il livello per farli apparire.
* [Esportazione] L’esportazione SBSAR di una luce ambientale perde la precisione 32profondità di bit
