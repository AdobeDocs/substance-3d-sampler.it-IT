...
**Substance Alchemist 2019.1 &quot;Sesame&quot;** consente di condividere le risorse con la nuova gestione del progetto. La Pila livelli è stata completamente ricostruita per migliorare il flusso di lavoro. Ulteriori controlli e informazioni sono stati aggiunti alla finestra della vista. Una nuova versione di Delighter migliora la qualità e la precisione dei materiali.
...
La Pila livelli è stata ricostruita da zero per ampliarne le possibilità e le azioni. Modifiche degne di nota:

* **È ora possibile accedere a materiali e maschere direttamente tramite l&#39;icona dedicata**\
  Quando si aggiunge un materiale nella Pila livelli, ora viene visualizzata una nuova icona maschera. Facendo clic su questa seconda icona verranno visualizzati i parametri di fusione del materiale.

  ![](../../assets/sa-notes-layermask.png)
* **La modalità Fusione può essere modificata direttamente dalla barra degli strumenti**\
  D&#39;ora in poi, quando è selezionato un livello di materiale, il suo metodo di fusione può essere modificato direttamente dalla barra degli strumenti Pila livelli, senza dover fare clic sulla maschera.
...
* **Campo visivo della fotocamera**\
  È ora possibile modificare il campo di visualizzazione (FOV) della finestra della vista. Regolare questo valore può aiutare a visualizzare in modo realistico i materiali. Il campo visivo può essere controllato solo in modalità di proiezione Prospettiva.

  ![](../../assets/sa-notes-viewport-fov.png)
* **Risoluzione e profondità di bit per canale**\
  La Vista 2D ora visualizza la risoluzione della texture e la profondità di bit di ciascun canale.
...
* [Crea] Assegnazione di un budget VRAM sufficiente per ottenere buoni risultati
...
* [Flusso di lavoro] Supporto del flusso di lavoro di Lucentezza degli Specular PBR
...
* [Livelli] Correggere un arresto anomalo quando si aggiunge un livello di patch clone
...
* [Risorse] Non eseguire l&#39;arresto anomalo durante la navigazione nel pannello Risorse
* [Resources] Correggere l&#39;arresto anomalo durante l&#39;importazione di file di Substance danneggiati
* [Resources] Riduzione del numero di arresti anomali durante il caricamento di cartelle di grandi dimensioni
...
* [Applicazione] Correggi arresti anomali all&#39;uscita durante l&#39;esportazione dei materiali
...
* [Layers] Annulla l’impostazione del parametro Image Input quando si elimina il livello
* [Livelli] Correggere un arresto anomalo quando si aggiunge un livello di patch clone
* [Livelli] Correggi alcuni arresti anomali quando si fondono livelli, impilano materiali in altri materiali di Pila livelli
* [Esporta] La selezione dei canali per l’esportazione è ora rispettata
* [Risorse] Non eseguire l&#39;arresto anomalo durante la navigazione nel pannello Risorse
* [Resources] Correggere l&#39;arresto anomalo durante l&#39;importazione di file di Substance danneggiati
* [Resources] Riduzione del numero di arresti anomali durante il caricamento di cartelle di grandi dimensioni
...
* [Fusione] Nuova modalità Fusione opacità
...
* [Livelli] Correggi arresto anomalo durante la rimozione del livello inferiore
...
* [Livelli] Evitare arresti anomali durante l’utilizzo dei filtri Clona /Clone patch e Riempimento in base al contenuto
* [Layers] Correggere l&#39;arresto anomalo mentre si trascina e si rilascia un filtro negli slot di input di uno splatter
* [Resources] Correggere l&#39;arresto anomalo durante il collegamento di cartelle locali o l&#39;importazione di risorse in Substance Alchemist
* [Raccolta] Correggi l&#39;arresto anomalo durante il passaggio rapido tra i materiali
* [UI] Correggere l&#39;arresto anomalo mentre il valore è null o non valido nell&#39;Affiancamento, i cursori di spostamento nella finestra della vista
* [Ispirazione] Correggi arresto anomalo durante l&#39;accesso alla scheda Ispirazione
* [Ispirazione] Correggere l&#39;arresto anomalo mentre si ispira su un livello appena salvato sovrapporre il materiale
* [Prestazioni] I materiali e i filtri pesanti della Substance (Affiancamento) vengono elaborati più rapidamente
...
* [Contenuto] Fusione Fusione AO corretta
* [Contenuto] Fusione corretta Fusione curvatura
* [Content] Fusione corretta Fusione ID colore
* [Contenuto] Fusione corretta Fusione maschera personalizzata
...
* [Menu File] Accedere ai comandi del progetto dalla scheda File e al salvataggio della Pila livelli
...
* [Layers] Nuova architettura della Pila livelli
* [Layers] Nuova interfaccia utente della Pila livelli
...
* [Layers] Aggiungete materiali direttamente negli input dedicati del filtro Spruzzo nella Pila livelli
...
* [Finestra vista] Possibilità di passare da fotocamera ortografica a Prospettiva
...
* [Flusso di lavoro] Specular/Lucentezza temporaneamente disattivato
...
* [Contenuto] Il filtro di Trasforma include un’opzione di Trasforma sicura
...
* [Content] Il filtro splatter accetta Atlas con mappa completa dell&#39;altezza
* [Contenuto] Il filtro Trasforma funziona su immagini (scan1, scan2,...)
