...
**Substance 3D Sampler 3.3.0** introduce una serie di nuovi strumenti, contenuti e funzionalità per creare e modificare più facilmente materiali e luci ambiente.
...
Riempimento in base al contenuto può aiutare a rimuovere elementi di grandi dimensioni per evitare ripetizioni durante la suddivisione in porzioni di un materiale o rimuovere piccole imperfezioni sul tessuto scansionato.
...
Le luci dell&#39;ambiente di editing e 360 immagini possono essere difficili quando vengono visualizzate come immagini normali. Tutti gli elementi risultano distorti rendendo quasi impossibile la modifica. Con la nuova proiezione sferica, potete navigare a 360° e apportare modifiche con strumenti dedicati come Nadir patch, Riempimento in base al contenuto e tutte le luci procedurali senza distorsione. Ad esempio, ora è più facile modificare o pulire le linee rette, rimuovere il treppiede dalla fotocamera e posizionare perfettamente le luci della linea.
...
Nella vista 2D, potete modificare temporaneamente l&#39;esposizione per visualizzare meglio i dettagli o gli oggetti sulle parti sottoesposte o sovraesposte dell&#39;ambiente che state modificando.

### Impostazioni del visualizzatore dedicato

Le impostazioni del visualizzatore sono persistenti per tipo di risorsa (materiale o luce ambientale). Puoi impostare la trama, le texture predefinite o il campo visivo della videocamera per ogni tipo di risorsa per passare più facilmente da una all’altra e lavorare nel contesto corretto.

## Widget migliorati

### Timbro clone

Con questo aggiornamento Timbro clone, potete colorare più tratti di timbro con varie sorgenti in un singolo livello e accedere alla cronologia del timbro nel gruppo di livelli. Inoltre, è ora possibile visualizzare il risultato del timbro direttamente nell’anteprima del pennello prima di colorare. Questo semplifica la pulizia dei materiali ed evita che si ripetano spesso spostamenti tra le viste.

### Ritaglio e trasformazione
...
La nuova interfaccia utente, simile ai prodotti di Adobe più recenti come Fresco, consente di spostare la barra degli strumenti in qualsiasi punto della vista 2D, in verticale o in orizzontale. Mentre colorate, passate dal pennello alla gomma con il tasto E e utilizzate le nuove opzioni di affiancatura per controllare meglio ciò che colorate.

## Da immagine a materiale (basato sull&#39;intelligenza artificiale)

### Mantieni porzioni

Da immagine a materiale (basata su intelligenza artificiale) ottiene una nuova opzione: può ora mantenere la suddivisione in porzioni dell&#39;immagine affiancabile, riducendo il tempo necessario per suddividere il materiale in porzioni.

## Interoperabilità

Invia materiali a Stager

Era già possibile inviare le luci ambiente a Stager. Ora puoi inviare i tuoi materiali a Stager con un solo clic, proprio come puoi fare con Designer e Painter. Grazie a questa funzione, non è più necessario pubblicare i materiali e caricarli in Stager come file singoli (richiede Stager versione 1.2.0 con il nuovo gestore materiali).
...
* [Contenuto] Riempimento in base al contenuto funziona su immagini, materiali PBR e luci ambiente
* [Content] Aggiungi il parametro &quot;Mantieni porzioni&quot; all&#39;immagine sul materiale (basata su IA)
* [Contenuto] Il filtro Trasformazione prospettica può visualizzare una griglia tra i suoi quattro punti
...
* [Strumenti] Il cursore Timbro clone offre un’anteprima di ciò che verrà timbrato
* [Strumenti] Visualizza in anteprima il contenuto originale nel cursore Gomma quando si utilizza Timbro clone
* [Strumenti] Ctrl+Clic crea un nuovo timbro nel livello Timbro clone
...
* [Strumenti] Nuove opzioni di affiancamento del pennello in base all’asse
* [Strumenti] Quando colorate, nascondete/visualizzate la sovrapposizione sulla vista 2D
* [Tools] Nuova scelta rapida, il tasto &quot;X&quot;, per alternare tra Pennello e Gomma
* [Strumenti] Nuova scelta rapida, &quot;[&quot; &quot;]&quot; per modificare la dimensione del pennello
...
* [Vista 2D] La modalità proiezione sferica supporta Annulla/Ripeti
...
* [UI] Nuova posizione delle informazioni sulla risoluzione nella vista 2D
...
* [Filtri composti] I filtri composti gestiscono le variazioni per lavorare su immagini, materiali PBR e luci ambiente
...
* [Applicazione] L&#39;applicazione potrebbe arrestarsi in modo anomalo quando si passa alla visualizzazione 2D
...
* [Applicazione] Aggiornamento dell&#39;URL alla documentazione di importazione delle texture
* [Contenuto] Quando si utilizza un filtro composto, richiede di essere aggiornato quando non dovrebbe, al ricaricamento
* [Contenuto] I dettagli nella mappa del height scompaiono quando si utilizza Fusione opacità
