...
Create una luce a forma di rettangolo o disco.
...
* **Esposizione forma (EV)**: 0-10\
  Regolare l’esposizione della luce
* **Durezza forma**: 0-1\
  Ammorbidite i bordi della luce
* **Dimensione hotspot**: 0-1
* **Falloff hotspot**: 0-1\
  Regola la morbidezza dei bordi del punto attivo.
