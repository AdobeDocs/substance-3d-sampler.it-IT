...
* **Griglia**:\
  Regolate il numero di divisioni nella griglia. Aumentando il numero di divisioni otterrete un maggiore controllo sull’alterazione.
* **Mostra griglia**: attiva/disattiva\
  Quando questa opzione è attivata, viene visualizzata una griglia sul materiale per visualizzare più facilmente gli effetti del filtro
* **Campionamento di alta qualità**: attiva/disattiva\
  Abilita per aumentare la qualità di campionamento per risultati migliori.
