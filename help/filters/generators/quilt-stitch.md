...
Emulare un motivo di unione superfici unito nei materiali con questo filtro.

*Prima e dopo l&#39;applicazione del **filtro Punto unione superfici**.*
...
* **Topstitch**: attiva/disattiva\
  Abilita per aggiungere un topstitch e visualizzare la sezione dei parametri pertinenti
* **Striscia**: attiva/disattiva\
...
* **Colore topstitch**: selezione colore\
  Imposta il colore del filetto utilizzato per l&#39;unione superiore
* **Scostamento Topstitch**: 0-1\
  Scostare l&#39;unione superfici dai bordi dell&#39;area trapuntata
* **Rotazione punto di montaggio**: 0-1\
  Cambiare l&#39;orientamento dei punti che compongono il punto superiore
* **Scala Topstitch**: 0-1\
  Regolate le dimensioni del punto di attacco in ogni dimensione: larghezza, lunghezza e height
* **Intensità perforazione**: 0-1\
  Regolate il rientro nell&#39;unione superfici causata dal punto di sutura
* **Rugosità punto di sutura**: 0-1\
  Regolare la ruvidità del filetto
* **Metallico Topstitch**: 0-1\
  Regolare il valore metallico del filetto
...
* **Tipo unione superfici**:\
  Selezionate lo stile di unione superfici da utilizzare
